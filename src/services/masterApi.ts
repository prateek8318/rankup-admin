...
export const examApi = {
  ...
  getAll: (language?: string, languageId?: number, countryCode?: string, qualificationId?: number, streamId?: number, minAge?: number, maxAge?: number) => {
  ...
  create: (data: CreateExamDto) => 
    ...
    masterApiClient.post('/exams', data),

  

  update: (id: number, data: UpdateExamDto) => 

    masterApiClient.put(`/exams/${id}`, data),

  

  delete: (id: number) => 

    masterApiClient.delete(`/exams/${id}`),

  

  deleteImage: (examId: number) => 

    masterApiClient.delete(`/exams/${examId}/delete-image`),

  

  updateStatus: (id: number, isActive: boolean) => 

    masterApiClient.patch(`/exams/${id}/status`, isActive)

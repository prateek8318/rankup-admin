    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <div style={styles.subtitle}>
          We have Sent A verification code to mobile number whenever you Login in your account
        </div>
        ...
        <div style={styles.mobileInputWrapper}>
          <img
            ...
            onError={(e) => {
              ...
              target.src = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 16'%3E%3Crect width='24' height='16' fill='%23FF9933'/%3E%3Crect width='24' height='4' fill='%23FFFFFF'/%3E%3Crect width='24' height='4' y='6' fill='%23138808'/%3E%3Crect width='24' height='4' y='12' fill='%23FF9933'/%3E%3Ccircle cx='12' cy='8' r='2' fill='%23000080'/%3E%3C/svg%3E";
            }}
          />
        ...
        <div style={styles.timer}>
          ...
          Send OTP again in <span style={styles.countdown}>{formatTime(countdown)} sec</span>
        </div>
        ...
        <button
          style={{
            ...styles.button,
            ...(verifying || !isComplete ? styles.buttonDisabled : {}),
          }}

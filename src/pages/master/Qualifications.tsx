...
const Qualifications = () => {
  ...
  const [countries, setCountries] = useState<CountryDto[]>(mockCountries);
  ...
  const fetchQualifications = async () => {
    try {
      setLoading(true);
      const data = await qualificationApi.getAllQualifications();
  ...
  const handleEdit = (qualification: QualificationDto) => {
    ...
    setSelectedCountry(qualification.countryCode);
              ...
              <tbody>
                {filteredQualifications.map((qualification) => (
                  <tr key={qualification.id} style={{ borderBottom: "1.5px solid #C0C0C0" }}>
                    ...
                    <td style={{ padding: "12px", fontSize: "14px" }}>{qualification.countryCode}</td>
                    <td style={{ padding: "12px", fontSize: "14px" }}>
                      <div style={{ display: "flex", flexWrap: "wrap", gap: "4px" }}>
                        {qualification.names.map((name) => (
                          <span
                            key={name.languageId}
                            style={{
                              padding: "2px 6px",
                    ...
                    <td style={{ padding: "12px" }}>
                      <span style={{
                        ...
                        fontSize: "12px",
                        fontWeight: "500",
                        background: qualification.isActive ? "#dcfce7" : "#fee2e2",
                        color: qualification.isActive ? "#166534" : "#991b1b"
                      }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                <p style={{ fontSize: "12px", color: "#6b7280", marginTop: "4px" }}>
                  Select multiple languages for qualification name and description translations.
                </p>
              </div>
              ...
              <div style={{ display: "flex", gap: "10px", justifyContent: "flex-end" }}>
                ...
                >
                  {isTranslating ? 'Translating...' : (editingQualification ? "Update" : "Create")}
                </button>
              </div>
            </form>
          </div>
